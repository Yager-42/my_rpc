...
public class NacosUtil {
    ...
    public static void registerService(String serviceName, InetSocketAddress address, String group) throws NacosException {
        if(group.equals("")){
            namingService.registerInstance(serviceName, address.getHostName(), address.getPort());
        }else {
            Instance instance = new Instance();
            instance.setIp(String.valueOf(address.getAddress()));
